...
class MenClothing {
	...
	onLoad = "[] execVM 'zupaskins\List_Men.sqf'";
	...
	class controls {
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.125; h = 0.05;
			text = "Change Skin";
			onButtonClick = "execVM 'zupaskins\GetMen.sqf'";
		};
...
class WomanClothing {
	...
	movingEnable = true;
	enableSimulation = true;
	onLoad = "[] execVM 'zupaskins\List_Woman.sqf'";
	...
	class controls {
		...
		class RecruitButton: HW_RscGUIShortcutButton {
			...
			w = 0.125; h = 0.05;
			text = "Change Skin";
			onButtonClick = "execVM 'zupaskins\GetWoman.sqf'";
		};
		class CloseButton: RecruitButton {
			x = 0.15;
			text = "Close";
